...
public class Engine {   
    ...
    public void init(){
        ...
        Entity tilemap = ecs.createEntity(null, 
                new Sprite(), 
                new Position(new Vector2D(0, 0)), 
                TileMapLoader.LoadTileMap("src\\com\\pochitoGames\\Resources\\TileMaps\\iso_2.csv", "src\\com\\pochitoGames\\Resources\\TileMaps\\tileset_2.png", 30, 30, 64, 32, TilesetMode.ISOMETRIC));
